...
public class UpdateProductCompleteAction extends ActionSupport implements SessionAware{
	...
	public String execute(){
		...
		if(session.get("adminLogined").equals(1)){
			...
			int count=productInfoDAO.updateProduct(
				String.valueOf(session.get("updateproductName")),
				String.valueOf(session.get("updateproductNameKana")),
				String.valueOf(session.get("updateproductDescription")),
				String.valueOf(session.get("updatecategoryId")),
				String.valueOf(session.get("updateprice")),
				String.valueOf(session.get("image_file_path")),
				String.valueOf(session.get("image_file_name")),
				String.valueOf(session.get("updatereleaseDate")),
				String.valueOf(session.get("updatereleaseCompany")),
				Integer.parseInt(String.valueOf(session.get("updateproductId"))));
			if(count>0){
				cartInfoDao.updatePrice(String.valueOf(session.get("updateprice")), String.valueOf(session.get("updateproductId")));
				result=SUCCESS;
			}else{
				result=ERROR;
			}
